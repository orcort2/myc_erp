...
def classify(path: Path) -> tuple[str, str, str, str, str]:
    ...
    work_order_deletion_files = {
        ...
        "backend/app/services/lab_work_orders.py": ("Autoridad OT LAB", "Gestiona folios, cohortes, clasificación de identidad y cierre transaccional con consolidación selectiva de FieldSheets/PDFs; conserva historia y eliminación atómica.", "Modelos LAB, Tickets, Notifications, Communications, auditoría y PDFs", "Router LAB, MYC Mobile y pruebas", "Crítico"),
