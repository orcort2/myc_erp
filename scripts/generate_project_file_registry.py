...
def classify(path: Path) -> tuple[str, str, str, str, str]:
    ...
    work_order_deletion_files = {
        ...
        "myc-mobile/app/(technician)/work-orders.tsx": ("Flujo OT LAB móvil", "Distingue grupo histórico y cohorte; ofrece cierre grupal/individual, explica faltantes y navega estado/PDF por folio.", "AuthProvider, API LAB, permisos, política/servicio de firma, Notifications y Expo", "Técnicos y Administrador móvil", "Crítico"),
