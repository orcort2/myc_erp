...
def classify(path: Path) -> tuple[str, str, str, str, str]:
    ...
    sales_exception_files = {
        ...
        "backend/app/core/permissions.py": (
            ...
            "Declara roles y permisos segregados para solicitar, autorizar, inspeccionar y ejecutar la reconstrucción controlada, además de administrar clasificación, empresas y prefijos.",
        ...
        "frontend/src/pages/QuotationsPage.jsx": (
            ...
            "Compone listado, detalle y catálogo; durante una autorización edita partidas directamente, muestra el delta y guarda la nueva revisión que reconstruye el ETS.",
