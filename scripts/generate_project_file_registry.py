...
def classify(path: Path) -> tuple[str, str, str, str, str]:
    ...
    field_sheet_dsl_files = {
        ...
        "backend/app/templates/field_sheet_engine_pdf.html": ("Renderer HTML canónico", "Presenta layouts, tablas y firmas horizontales/verticales con campos posteriores ya resueltos, sin lógica por template.", "Contexto field_sheet_pdfs, Jinja y WeasyPrint", "PDFs nuevos ERP/LAB y snapshots v1 compatibles", "Crítico"),
        "backend/tests/test_field_sheet_layout_dsl.py": ("Aceptación DSL/PDF Hojas de Campo", "Prueba layouts, perfiles, firmas horizontal/vertical, trailing fields allowlisted, rechazos 422 y PDF real, incluidas Temperatura/Presión oficiales.", "Pytest, normalizador, Jinja y WeasyPrint", "Gate Fases 4+5/6A.1", "Crítico"),
        ...
        "docs/closures/FIELD_SHEET_CATALOG_PHASE_6A1_2026-09-03.md": ("Evidencia Fase 6A.1 FieldSheets", "Registra fuentes, definiciones, compatibilidad, PDFs y validaciones de Temperatura/Presión MYC con estado EN REVISIÓN.", "Código, PDFs fuente, arquitectura y suites", "Desarrollo, QA y auditoría", "Alto"),
    }
