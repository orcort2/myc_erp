...
STATUS_OVERRIDES = {
    ...
    "backend/app/resolution_integrations/service_order_administration/__init__.py": "En revisión",
    "backend/app/resolution_integrations/service_order_administration/application.py": "En revisión",
    "backend/app/resolution_integrations/service_order_administration/domain.py": "En revisión",
    "backend/app/resolution_integrations/service_order_administration/infrastructure.py": "En revisión",
    "backend/app/services/service_order_administration.py": "En revisión",
    "backend/tests/resolution_engine/test_phase_15_service_order_administration.py": "En revisión",
    "docs/architecture/resolution-engine/32_PHASE_15_ADMINISTRATIVE_TOOLS.md": "En revisión",
    "docs/audits/ADMINISTRATIVE_OPERATIONS_INVENTORY_2026-08-25.md": "En revisión",
    "backend/app/resolution_integrations/installed.py": "En revisión",
    "backend/app/resolution_center/definitions.py": "En revisión",
    "backend/app/resolution_center/schemas.py": "En revisión",
    "backend/app/resolution_center/workflow.py": "En revisión",
    "frontend/src/pages/ResolutionCenterPage.jsx": "En revisión",
    "frontend/src/pages/resolution-center.css": "En revisión",
    "frontend/src/pages/resolutionCenterAdministrativeTools.test.js": "En revisión",
    "docs/closures/LAB_CLOSURE_COHORTS_2026-08-27.md": "En revisión",
    "myc-mobile/src/services/lab-work-order-closure.ts": "En revisión",
...
FORCE_RECLASSIFY = {
    ...
    "myc-mobile/src/services/field-labels.ts",
    "myc-mobile/src/design/primitives.wiring.test.ts",
    "backend/app/main.py",
    "backend/app/models/lab_work_order.py",
    "backend/app/routers/lab_clients.py",
    "backend/app/routers/lab_work_orders.py",
    "backend/app/schemas/lab_work_order.py",
    "backend/app/services/lab_work_order_pdfs.py",
    "backend/app/services/lab_clients.py",
    ...
    "backend/tests/test_lab_domain_phase1.py",
    ...
    "docs/closures/LAB_CLOSURE_COHORTS_2026-08-27.md",
    "myc-mobile/app/(auth)/login.tsx",
    "myc-mobile/app/(technician)/index.tsx",
    "myc-mobile/app/(technician)/work-orders.tsx",
    "myc-mobile/app/(technician)/clients.tsx",
    "myc-mobile/src/api/client.ts",
    "myc-mobile/src/auth/AuthProvider.tsx",
    "myc-mobile/src/components/lab/LabClientSelector.tsx",
    "myc-mobile/src/components/lab/LabClientSelector.wiring.test.ts",
    ...
    "myc-mobile/src/services/lab-work-order-closure.test.ts",
    "myc-mobile/src/services/lab-work-order-closure.ts",
    "myc-mobile/src/services/lab-client-selector.ts",
    "myc-mobile/src/services/lab-client-selector.test.ts",
    ...
    "backend/app/resolution_integrations/installed.py",
    "backend/app/resolution_integrations/service_order_administration/__init__.py",
    "backend/app/resolution_integrations/service_order_administration/application.py",
    "backend/app/resolution_integrations/service_order_administration/domain.py",
    "backend/app/resolution_integrations/service_order_administration/infrastructure.py",
    "backend/app/services/service_order_administration.py",
    "backend/tests/resolution_engine/test_phase_15_service_order_administration.py",
    "docs/architecture/resolution-engine/32_PHASE_15_ADMINISTRATIVE_TOOLS.md",
    "docs/audits/ADMINISTRATIVE_OPERATIONS_INVENTORY_2026-08-25.md",
    "frontend/src/pages/ResolutionCenterPage.jsx",
    "frontend/src/pages/resolution-center.css",
    "frontend/src/pages/resolutionCenterAdministrativeTools.test.js",
    "docs/BACKUP_ESTADO_ACTUAL.md",
    "docs/architecture/CALIBRATION_SCOPE_CONTRACT.md",
    "docs/closures/LAB_CLIENT_IMPORT_AND_QUERY_2026-09-02.md",
...
FORCE_RECLASSIFY.update({
    ...
    "backend/app/services/field_sheet_layouts.py",
    ...
    "backend/tests/test_field_sheet_layout_dsl.py",
    ...
    "docs/closures/FIELD_SHEET_DSL_PHASES_4_5_2026-09-02.md",
    "docs/closures/FIELD_SHEET_CATALOG_PHASE_6A1_2026-09-03.md",
    ...
    "myc-mobile/src/services/field-sheet-result-layout.test.ts",
    "myc-mobile/src/services/field-sheet-result-layout.ts",
    "myc-mobile/src/types/lab-work-order.ts",
...
FORCE_RECLASSIFY.update({
    "backend/app/models/operational_ticket.py",
    "backend/app/routers/operational_tickets.py",
    "backend/app/schemas/operational_ticket.py",
    "backend/app/schemas/lab_work_order.py",
    "backend/app/services/lab_field_sheets.py",
    "backend/app/services/lab_folio_requests.py",
    "backend/app/services/notification_events.py",
    "backend/app/services/operational_tickets.py",
    "backend/migrations/versions/9f3a2c7d1e84_add_reception_date_change_ticket_type.py",
    "backend/tests/test_operational_ticket_type_constraint.py",
    "backend/tests/test_lab_field_sheets_capture.py",
    "backend/tests/test_lab_phase2_integrated_alta.py",
    "backend/tests/test_lab_phase6_field_sheet_revisions.py",
    "backend/tests/test_mobile_notifications.py",
    "myc-mobile/app/(technician)/tickets.tsx",
    "myc-mobile/app/(technician)/work-orders.tsx",
    "myc-mobile/src/api/client.ts",
    "myc-mobile/src/api/error-detail.ts",
    "myc-mobile/src/api/error-detail.test.ts",
    "myc-mobile/src/components/field-sheets/FieldSheetResultsWorkspace.tsx",
    "myc-mobile/src/components/lab/LabEquipmentForm.tsx",
    "myc-mobile/src/components/lab/LabEquipmentForm.wiring.test.ts",
    "myc-mobile/src/components/lab/LabTechnicalCapture.tsx",
    "myc-mobile/src/components/lab/LabTechnicalCapture.wiring.test.ts",
    "myc-mobile/src/design/MycDatePickerField.tsx",
    "myc-mobile/src/design/MycDatePickerField.wiring.test.ts",
    "myc-mobile/src/design/primitives.tsx",
    "myc-mobile/src/permissions/mobile-capabilities.ts",
    "myc-mobile/src/permissions/mobile-capabilities.test.ts",
    "myc-mobile/src/services/civil-date.ts",
    "myc-mobile/src/services/civil-date.test.ts",
    "myc-mobile/src/services/field-sheet-template-selector.ts",
    "myc-mobile/src/services/field-sheet-template-selector.test.ts",
    "myc-mobile/src/services/lab-field-sheet-mobile-refresh.test.ts",
    "myc-mobile/src/services/lab-work-order-closure.test.ts",
    "myc-mobile/src/requests/request-inbox.test.ts",
    "myc-mobile/src/types/operational-ticket.ts",
    "myc-mobile/src/wiring-tests/work-orders.operational-ux.wiring.test.ts",
    "docs/architecture/LAB_WORK_ORDERS.md",
    "docs/architecture/OPERATIONAL_TICKETS_AND_LAB_REOPENING.md",
    "docs/closures/LAB_OPERATIONAL_UX_CLOSURE_2026-09-03.md",
})
SECTION_ORDER = (
...
MOBILE_SESSION_FILES = {
    ...
    'myc-mobile/src/auth/AuthProvider.tsx': ('Coordinador único de sesión Mobile', 'Restaura tokens, comparte refresh single-flight con HTTP/realtime, evita 401 tardíos y restauración tras logout; intenta baja push antes de revocar auth y limpia local aun si ambos fallan.', 'React Context, auth.service, SecureStore y push-notifications', 'Todas las superficies MYC Mobile y RealtimeProvider', 'Crítico'),
    'myc-mobile/src/auth/AuthProvider.test.ts': ('Regresión ejecutable auth Mobile', 'Ejecuta provider/servicios/storage reales con puertos simulados: tres 401, realtime, fallo compartido, orden push/auth, fallos de ambos servicios, logout en vuelo, UUID persistente y transición legacy/opaco.', 'node:test, TypeScript y módulos auth reales', 'Suite MYC Mobile', 'Crítico'),
...
def classify(path: Path) -> tuple[str, str, str, str, str]:
    ...
    hotfix_lab_files = {
        ...
        'backend/app/templates/field_sheet_lab_externo_pdf.html': ('Parcial de resultados externos', 'Presenta grupos, orientación y tablas dinámicas dentro del layout canónico; no mantiene HTML completo ni campos comunes duplicados.', 'field_sheet_engine_pdf.html, external_groups', 'Renderer PDF LAB EXTERNO', 'Alto'),
        'backend/app/services/auth.py': ('Autoridad de autenticación y permisos', 'Resuelve identidad y permisos internos; calcula autoridad administrativa para folios propios con rol Administrador activo, actor interno y lab_folios.resolve.', 'Roles, permisos, JWT, User', 'Auth ERP/Mobile y Tickets', 'Crítico'),
        'backend/app/services/operational_tickets.py': ('Lifecycle de Tickets LAB', 'Resuelve Tickets con auditoría y notificaciones; auto-resolución sólo de linked_folio/manual_myc_folio para administrador interno autorizado. Conserva bloqueo en tickets sensibles.', 'SQLAlchemy, auth, OT LAB, Notifications', 'API operativa y Mobile', 'Crítico'),
        'backend/app/core/mobile/security.py': ('Seguridad de sesión Mobile', 'Resuelve contexto interno/externo y emite login/refresh con capability backend can_resolve_own_lab_folios.', 'Auth, membresías, permisos, JWT', 'API Mobile', 'Crítico'),
        'backend/app/routers/mobile_auth.py': ('API de autenticación Mobile', 'Expone login, refresh y me con autoridad administrativa de folios derivada del backend.', 'MobileSecurityContext, auth, MobileUserRead', 'Clientes Mobile', 'Crítico'),
        'backend/app/schemas/mobile_auth.py': ('Contrato de autenticación Mobile', 'Proyecta identidad, permisos y capability de folios propios; default false para compatibilidad.', 'Pydantic', 'API Mobile', 'Alto'),
        'backend/tests/test_operational_ticket_self_resolution.py': ('Regresión de auto-resolución administrativa', 'Cubre ambos folios, segundo revisor, rol/permiso/contexto, tipos sensibles, auditoría y notificaciones persistentes.', 'Pytest, SQLite, fixtures LAB, servicios Tickets', 'Gate backend', 'Crítico'),
        'myc-mobile/src/permissions/mobile-capabilities.ts': ('Capabilities Mobile', 'Deriva capacidades por actor y permisos; consume autoridad backend para folios propios y decide visibilidad por tipo, solicitante y estado pending.', 'AuthUser, permisos', 'Pantallas Mobile', 'Crítico'),
        'myc-mobile/src/types/auth.ts': ('Tipos de autenticación Mobile', 'Incluye autoridad opcional backend de auto-resolución de folios, fail-closed al faltar.', 'Contrato MobileUserRead', 'Auth y capabilities Mobile', 'Alto'),
    }
    if value in hotfix_lab_files:
        return hotfix_lab_files[value]

    lab_field_sheet_reopen_and_folio_fix_files = {
        "backend/tests/test_lab_certificate_folio_distribution.py": ("Regresión de distribución de folios de certificado", "Cubre preview/distribute todo-o-nada de MYCA/MYCT pendientes de cliente operativo externo: orden por posición, idempotencia, aislamiento por operator_client_id y concurrencia real PostgreSQL sobre el ticket certificate_folio_block.", "Pytest, SQLAlchemy y servicios LAB de folios", "Gate backend de folios de certificado LAB", "Crítico"),
        "myc-mobile/src/services/field-labels.ts": ("Etiquetas humanas de campo compartidas", "Centraliza el mapa clave→etiqueta usado por LabTechnicalCapture (missingFields) y error-detail.ts (mensajes 422 humanizados) para que ambos no diverjan.", "TypeScript puro, sin React Native", "LabTechnicalCapture.tsx y error-detail.ts", "Alto"),
        "myc-mobile/src/design/primitives.wiring.test.ts": ("Regresión del primitive Field", "Verifica que maxLength sea opt-in en Field, se propague al TextInput y active el contador N/max sin afectar a los callers existentes.", "node:test y fuente de primitives.tsx", "Gate Mobile", "Medio"),
        "myc-mobile/src/services/lab-certificate-folio-distribution.ts": ("Cliente API de distribución de folios", "Tipa y llama GET/POST .../certificate-folios/{preview,distribute}; expone isFolioDistributionSufficient/hasNoPendingCertificateFolios como única autoridad para decidir si la UI ofrece confirmar.", "SignatureRequest inyectado (mismo patrón que lab-work-order-signature-submission.ts)", "work-orders.tsx", "Alto"),
        "myc-mobile/src/wiring-tests/work-orders.folio-distribution.wiring.test.ts": ("Regresión de Distribuir folios disponibles", "Verifica gate por canCancel, preview antes de confirmar, botón de confirmar sólo con pool suficiente y refetch completo vía openExisting tras distribuir.", "node:test y fuente de work-orders.tsx", "Gate Mobile", "Alto"),
    }
    if value in lab_field_sheet_reopen_and_folio_fix_files:
        return lab_field_sheet_reopen_and_folio_fix_files[value]
    ...
    work_order_deletion_files = {
        ...
        "backend/app/security/api_access.py": ("Política transversal de acceso", "Clasifica 477 operaciones deny-by-default y separa permisos internos, Portal y Mobile.", "FastAPI, auth, catálogo de permisos e inventario CSV", "Middleware, arranque, generador y pruebas de conformidad", "Crítico"),
        ...
        "backend/tests/test_api_access_conformity.py": ("Prueba de conformidad API", "Exige clasificación de las 477 operaciones y coincidencia exacta entre runtime e inventario CSV.", "app.main, security.api_access e inventario CSV", "Suite backend y revisión de API", "Crítico"),
        ...
        "backend/app/routers/lab_work_orders.py": ("API OT LAB", "Expone cierre/firma grupal o individual, cambio de modalidad, preview/distribución de folios certificado pendientes y DELETE administrativo con permisos/scope Mobile, sin reutilizar rutas productivas. Añade q opcional por folio OR cliente, conservando filtros legacy y scope.", "FastAPI, auth, schemas y servicio LAB", "MYC Mobile y pruebas LAB", "Crítico"),
        "backend/app/services/lab_work_orders.py": ("Autoridad OT LAB", "Gestiona folios (bloqueando accredited/traceable externo sin pool resuelto y reparando pendientes legacy vía Distribuir folios disponibles), grupo histórico, cohortes grupales/individuales, inmutabilidad completed, PDFs y eliminación atómica con reparación de cadena y recursos compartidos. Filtra q por subcadena literal de folio OR cliente case-insensitive, intersectado con filtros legacy y scope.", "Modelos LAB, Tickets, Notifications, Communications, auditoría y PDFs", "Router LAB, MYC Mobile y pruebas", "Crítico"),
        "backend/tests/test_lab_work_orders.py": ("Suite integral OT LAB", "Cubre lifecycle, cohortes, reapertura/eliminación y la importación LabClient histórica/estructurada con aliases, auxiliares ignorados, ceros iniciales, inválidos y duplicados. Prueba q, filtros legacy, estado, paginación y permiso/scope del listado.", "Pytest, FastAPI, openpyxl, SQLAlchemy y agregado LAB", "Gate backend del vertical temporal", "Crítico"),
        "myc-mobile/app/(technician)/work-orders.tsx": ("Flujo OT LAB móvil", "Distingue grupo histórico y cohorte, evita recapturar firmas históricas preservadas durante CTA/open/realtime/navegación relacionada y restablece el flujo normal al invalidarse; ofrece cierre grupal/individual, explica faltantes y navega estado/PDF por folio. Cabecera con buscador q debounced y dos accesos horizontales locales; conserva ajuste de teclado por plataforma.", "AuthProvider, API LAB, permisos, política/servicio de firma, Notifications y Expo", "Técnicos y Administrador móvil", "Crítico"),
        ...
        "docs/architecture/security/API_ENDPOINT_INVENTORY_2026-08-03.csv": ("Evidencia reproducible API", "Registra 477 operaciones con método, ruta, identidad, permiso, ownership y pruebas esperadas.", "generate_api_access_inventory.py y app runtime", "Conformidad, revisión externa y CI futura", "Crítico"),
    }
    ...
    notification_files = {
        ...
        "myc-mobile/package.json": ("Dependencias y gates móviles", "Fija dependencias Expo SDK 54 y scripts TypeScript, lint, autenticación, capacidades, sincronización, Realtime y eliminación OT LAB.", "npm, Expo SDK 54 y tsx", "Desarrollo, validación y builds manuales", "Crítico"),
    ...
    lab_operational_ux_files = {
        "backend/app/models/operational_ticket.py": ("Ticket operativo persistente", "Mantiene lifecycle y ocho tipos permitidos, incluido el Ticket informativo de cambio de fecha de recepción.", "SQLAlchemy, User, OT LAB y constraint Alembic", "Servicios de Tickets, Notifications y auditoría", "Crítico"),
        "backend/app/routers/operational_tickets.py": ("API móvil de Tickets", "Expone creación y atención de Tickets, incluido reception_date_change bajo actor y permisos efectivos.", "FastAPI, MobileSecurityContext, schemas y servicios", "MYC Mobile y staff revisor", "Crítico"),
        "backend/app/schemas/operational_ticket.py": ("Contratos de Tickets", "Valida solicitudes, resolución y payload informativo de fecha con IDs opcionales y fecha civil.", "Pydantic y modelos Ticket/LAB", "Router, servicios y cliente móvil", "Alto"),
        "backend/app/schemas/lab_work_order.py": ("Contratos OT LAB", "Valida datos generales, equipos, firmas y actualización canónica de fecha de recepción.", "Pydantic y modelos LAB", "Router, dominio y MYC Mobile", "Alto"),
        "backend/app/services/lab_field_sheets.py": ("Autoridad FieldSheet LAB", "Crea, edita, completa y descarta únicamente la revisión vigente editable, restaurando predecesora y estado OT; al retirar una completed por reapertura clona de inmediato la N+1 editable (nunca deja un hueco), y ofrece 'Cambiar Hoja de Campo' para cambiar de plantilla atómicamente.", "FieldSheet, equipo LAB, auditoría y renderer", "Router LAB, borrado OT, operational_tickets y pruebas", "Crítico"),
        "backend/app/services/lab_folio_requests.py": ("Autoridad de folio Vinculado", "Autoriza folio externo por lab_folios.resolve o preserva requested_folio/Ticket pending, sin consumir MYCA/MYCT.", "Equipo LAB, Tickets, permisos, auditoría y Notifications", "Alta/edición configurada y pruebas", "Crítico"),
        "backend/app/services/notification_events.py": ("Eventos de Notifications", "Resuelve destinatarios por uno o varios permisos y textos de creación/resolución, sin self-notification.", "Users/Roles, Tickets, push y realtime", "Servicios operativos y centro móvil", "Crítico"),
        "backend/app/services/operational_tickets.py": ("Lifecycle de Tickets LAB", "Crea y resuelve Tickets, incluido reception_date_change informativo sin mutar la fecha canónica; al resolver field_sheet_reopen o reabrir la cohorte con equipo objetivo, delega en lab_field_sheets el clon N+1 inmediato tras retirar la revisión completed.", "SQLAlchemy, OT LAB, permisos, auditoría, Notifications y lab_field_sheets", "Router móvil y revisores", "Crítico"),
        "backend/migrations/versions/9f3a2c7d1e84_add_reception_date_change_ticket_type.py": ("Migración de tipo Ticket", "Extiende ck_operational_ticket_type a ocho valores y bloquea downgrade si existen filas del tipo nuevo.", "Alembic, PostgreSQL y b0b560e714db", "Upgrade, rollback y validación de esquema", "Crítico"),
        "backend/tests/test_operational_ticket_type_constraint.py": ("Regresión de constraint Ticket", "Compara metadata/modelo/migración, acepta ocho tipos y rechaza cualquier tipo arbitrario.", "Pytest, SQLAlchemy y migración 9f3a2c7d1e84", "Gate backend/Alembic", "Alto"),
        "backend/tests/test_lab_field_sheets_capture.py": ("Regresión captura FieldSheet LAB", "Prueba captura/PDF/lifecycle y fecha de recepción editable, histórica e informativa por Ticket.", "Pytest, TestClient, SQLAlchemy y servicios LAB", "Gate backend LAB/FieldSheets", "Crítico"),
        "backend/tests/test_lab_phase2_integrated_alta.py": ("Regresión alta integrada LAB", "Cubre alta/edición atómica, folio Vinculado directo o pending con notificaciones e historial, y el bloqueo 409 de accredited/traceable externo sin pool certificate_folio_block resuelto.", "Pytest, TestClient, SQLAlchemy y servicios LAB", "Gate backend de equipos/folios", "Crítico"),
        "backend/tests/test_lab_phase6_field_sheet_revisions.py": ("Regresión de revisiones FieldSheet", "Verifica descarte draft/in_progress, restauración de predecesora, bloqueo de delete OT con historia, el clon N+1 automático al retirar una completed (reapertura/ticket field_sheet_reopen) y el cambio atómico de plantilla.", "Pytest, modelos y servicios LAB", "Gate backend de revisiones/borrado", "Crítico"),
        "backend/tests/test_mobile_notifications.py": ("Suite Notifications V1", "Prueba destinatarios, self-notification, resolución, realtime y payload Push con sonido/default y canal operational.", "Pytest, TestClient, SQLAlchemy y mocks Expo", "Gate backend móvil", "Crítico"),
        "myc-mobile/app/(technician)/tickets.tsx": ("Bandeja móvil de Tickets", "Presenta y atiende folios, reaperturas y solicitudes informativas de fecha según capacidad efectiva.", "Expo Router, API, capabilities y tipos Ticket", "Técnicos y staff revisor", "Crítico"),
        "myc-mobile/app/(technician)/work-orders.tsx": ("Flujo móvil OT LAB", "Orquesta datos/equipos/firmas/captura/cierre, errores por campo, fechas y acciones con primitives canónicos. Cabecera con buscador q debounced y dos accesos horizontales locales; conserva ajuste de teclado por plataforma.", "API LAB, capabilities, firma, calendario y componentes", "Staff y técnicos autorizados", "Crítico"),
        "myc-mobile/src/api/client.ts": ("Cliente API Mobile", "Propaga ApiError enriquecido y el contrato FieldError compartido sin alterar transporte autenticado.", "fetch, environment y error-detail", "Pantallas y servicios MYC Mobile", "Crítico"),
        "myc-mobile/src/api/error-detail.ts": ("Normalizador de errores API", "Convierte errores y 422 FastAPI en mensajes humanos y fieldErrors estructurados, humanizando string_too_long/string_too_short/missing por tipo Pydantic con las etiquetas compartidas de field-labels.ts.", "Response, contrato ApiError y field-labels", "Formularios LAB y workspace de resultados", "Crítico"),
        "myc-mobile/src/api/error-detail.test.ts": ("Pruebas de errores API", "Verifica códigos conocidos, detalle estructurado y loc Pydantic convertido a fieldErrors útiles.", "node:test y error-detail", "Gate Mobile", "Alto"),
        "myc-mobile/src/components/field-sheets/FieldSheetResultsWorkspace.tsx": ("Workspace de resultados FieldSheet", "Edita tablas declarativas y presenta banner/error por celda localizable sin perder cambios locales.", "React Native, ApiError y motor de resultados", "Captura técnica LAB", "Crítico"),
        "myc-mobile/src/components/lab/LabEquipmentForm.tsx": ("Formulario integrado de equipo LAB", "Usa Field compartido, folio Vinculado único con ayuda por autoridad, errores corregibles por campo y límite/contador de 4000 caracteres en Observaciones.", "Primitives, capacidades, cliente documental y payload", "work-orders.tsx", "Crítico"),
        "myc-mobile/src/components/lab/LabEquipmentForm.wiring.test.ts": ("Regresión UI equipo LAB", "Prueba input único Vinculado, ayuda por permiso y contrato Field/error por campo.", "node:test y fuente LabEquipmentForm", "Gate Mobile", "Alto"),
        "myc-mobile/src/components/lab/LabTechnicalCapture.tsx": ("Captura técnica móvil LAB", "Gestiona FieldSheet, descarte, fecha canónica/solicitud, calendario, selector completo y botones canónicos.", "API LAB, FieldSheet, date picker y primitives", "work-orders.tsx y técnicos", "Crítico"),
        "myc-mobile/src/components/lab/LabTechnicalCapture.wiring.test.ts": ("Regresión de captura técnica", "Verifica selector completo, fecha readonly/editable, Ticket informativo, descarte y canon de acciones.", "node:test y fuente LabTechnicalCapture", "Gate Mobile", "Alto"),
        "myc-mobile/src/design/MycDatePickerField.tsx": ("Selector de fecha MYC", "Presenta calendario modal civil YYYY-MM-DD con hoy, selección y shortcuts opcionales.", "React Native, tokens y civil-date", "Formularios OT y FieldSheet", "Alto"),
        "myc-mobile/src/design/MycDatePickerField.wiring.test.ts": ("Regresión de calendario MYC", "Verifica modal, grilla de siete columnas, formato y shortcuts basados en calibración.", "node:test y fuente del date picker", "Gate Mobile", "Medio"),
        "myc-mobile/src/design/primitives.tsx": ("Primitives visuales Mobile", "Centraliza botones, banners y Field con error, hint, required y maxLength/contador opt-in consistentes.", "React Native y tokens", "Pantallas/componentes MYC Mobile", "Crítico"),
        "myc-mobile/src/permissions/mobile-capabilities.ts": ("Capabilities Mobile", "Deriva autoridad explícita para resolver folios Vinculado y editar fecha de recepción sin roles hardcodeados.", "AuthUser y permisos efectivos", "Pantallas OT/equipo/Tickets", "Crítico"),
        "myc-mobile/src/permissions/mobile-capabilities.test.ts": ("Pruebas capabilities Mobile", "Cubre fronteras internal/client, folios y override de fecha junto con capacidades existentes.", "node:test y mobile-capabilities", "Gate de autorización UI", "Alto"),
        "myc-mobile/src/services/civil-date.ts": ("Aritmética de fecha civil", "Parsea/formatea YYYY-MM-DD, suma meses con clamp y genera celdas de calendario sin overflow temporal.", "Date local/UTC controlado", "MycDatePickerField y pruebas", "Alto"),
        "myc-mobile/src/services/civil-date.test.ts": ("Pruebas de fecha civil", "Verifica formato, fin de mes, años bisiestos, +6 meses y +1 año.", "node:test y civil-date", "Gate Mobile", "Alto"),
        "myc-mobile/src/services/field-sheet-template-selector.ts": ("Filtro de plantillas FieldSheet", "Busca sobre todas las plantillas y metadata informativa sin recortar la fuente.", "Tipos FieldSheet", "LabTechnicalCapture", "Alto"),
        "myc-mobile/src/services/field-sheet-template-selector.test.ts": ("Pruebas selector FieldSheet", "Verifica búsqueda completa por nombre/metadata/equipo y ausencia de recorte a cinco.", "node:test y selector", "Gate Mobile", "Alto"),
        "myc-mobile/src/services/lab-field-sheet-mobile-refresh.test.ts": ("Regresión refresh FieldSheet LAB", "Verifica refresco autoritativo y etiqueta vigente del folio Vinculado en el formulario único.", "node:test y fuentes LAB", "Gate Mobile", "Alto"),
        "myc-mobile/src/services/lab-work-order-closure.test.ts": ("Regresión de cohortes LAB", "Prueba cohortes, contextos y acciones grupales/individuales bajo primitives canónicos.", "node:test, política y fuente work-orders", "Gate Mobile", "Alto"),
        "myc-mobile/src/requests/request-inbox.test.ts": ("Regresión bandeja de solicitudes", "Prueba filtros y que Vinculado muestre identidad estructurada sin fallback de ID de equipo.", "node:test, helper y fuente tickets", "Gate Mobile", "Alto"),
        "myc-mobile/src/types/operational-ticket.ts": ("Contrato móvil de Tickets", "Tipifica lifecycle, contexto y los ocho tipos operativos, incluido reception_date_change.", "TypeScript y API backend", "Bandeja, filtros y navegación", "Alto"),
        "myc-mobile/src/wiring-tests/work-orders.operational-ux.wiring.test.ts": ("Regresión UX OT LAB", "Verifica canon de botones y cableado de fieldErrors en datos generales/equipo. Verifica cableado de búsqueda q, debounce, reset/paginación, accesos horizontales y ajuste único de teclado; no mide geometría.", "node:test y fuente work-orders", "Gate Mobile", "Alto"),
        "docs/architecture/LAB_WORK_ORDERS.md": ("Contrato OT LAB", "Documenta folio Vinculado, descarte/restitución FieldSheet, fecha canónica, calendario y delete seguro.", "Código y pruebas LAB", "Desarrollo, operación, auditoría y retiro", "Alto"),
        "docs/architecture/OPERATIONAL_TICKETS_AND_LAB_REOPENING.md": ("Contrato Tickets LAB", "Define ocho tipos y semántica informativa/no mutante de reception_date_change.", "Modelo, migración, servicios y Notifications", "Desarrollo, QA, seguridad y operación", "Crítico"),
        "docs/closures/LAB_OPERATIONAL_UX_CLOSURE_2026-09-03.md": ("Cierre técnico UX OT LAB", "Consolida implementación, migración, validaciones y QA físico pendiente del cierre previo al build.", "Código, arquitecturas, pruebas y respaldo", "Desarrollo, QA, operación y auditoría", "Alto"),
    }
    if value in lab_operational_ux_files:
        return lab_operational_ux_files[value]

    field_sheet_dsl_files = {
        "backend/app/schemas/field_sheet_template.py": ("Contrato DSL de Hojas de Campo", "Tipa tablas, layouts, perfiles y signature_layout cerrado con orientación, columnas y campos posteriores allowlisted.", "Pydantic y snapshots de plantilla", "API, normalizador, renderer y clientes", "Crítico"),
        "backend/app/services/field_sheet_layouts.py": ("Normalizador visual de Hojas de Campo", "Valida geometría, longitudes, print_layout y signature_layout; resuelve perfiles organizacionales y rechaza propiedades no permitidas.", "Schemas Pydantic y HTTPException", "Motor de plantillas y renderer PDF", "Crítico"),
        "backend/app/services/field_sheet_template_engine.py": ("Autoridad declarativa de plantillas", "Define familias, bloques y plantillas oficiales, incluidas Temperatura/Presión FCA-30 con geometría, layout y firmas declarativas, sin persistencia ni cálculos metrológicos.", "Schemas de plantilla y FastAPI", "Normalizador, catálogo y servicios FieldSheet", "Crítico"),
        "backend/app/services/field_sheet_templates.py": ("Motor declarativo de plantillas", "Normaliza bloques, resultados, print_layout y signature_layout; congela el contrato declarativo en snapshots compatibles.", "Definiciones persistentes, schemas, layouts y table families", "Servicios FieldSheet, API y renderer PDF", "Crítico"),
        "backend/app/services/field_sheet_pdfs.py": ("Autoridad documental PDF", "Compone contexto de página, tablas, perfiles, firmas y trailing fields con labels/valores canónicos para el renderer único versionado.", "FieldSheet, layouts, Jinja/WeasyPrint, snapshots y storage", "Endpoints PDF, paquetes y cierres FieldSheet", "Crítico"),
        "backend/app/templates/field_sheet_engine_pdf.html": ("Renderer HTML canónico", "Presenta layouts, tablas y firmas con acabado global compacto, radios exteriores, espaciado legible y campos posteriores resueltos, sin lógica por template.", "Contexto field_sheet_pdfs, Jinja y WeasyPrint", "PDFs nuevos ERP/LAB y snapshots v1 compatibles", "Crítico"),
        "backend/tests/test_field_sheet_layout_dsl.py": ("Aceptación DSL/PDF Hojas de Campo", "Prueba layouts, perfiles, firmas, acabado visual global estructural, rechazos 422 y PDF real de una página, incluidas Temperatura/Presión oficiales.", "Pytest, normalizador, Jinja, pypdf y WeasyPrint", "Gate Fases 4+5/6A.1", "Crítico"),
        "backend/tests/test_field_sheet_template_engine.py": ("Contrato de plantillas oficiales", "Verifica familias y geometría declarativa, metadata, headers, filas y firmas de las plantillas oficiales, incluidas Temperatura/Presión FCA-30.", "unittest, motor y normalizador de plantillas", "Gate del catálogo FieldSheet", "Crítico"),
        "backend/tests/test_lab_field_sheets_capture.py": ("Regresión captura FieldSheet LAB", "Prueba catálogo/captura/PDF/lifecycle LAB y acredita que metadata de equipo no restringe selección manual y que snapshots oficiales permanecen inmutables.", "Pytest, TestClient, SQLAlchemy y servicios LAB", "Gate backend LAB/FieldSheets", "Crítico"),
        "myc-mobile/src/services/field-sheet-result-layout.ts": ("Intérprete móvil de tablas declarativas", "Calcula matriz, posiciones y dimensiones reales de headers con colspan/rowspan; resuelve labels de fila y anchos seguros sin lógica por plantilla.", "Tipos FieldSheet TypeScript", "FieldSheetResultsWorkspace", "Alto"),
        "myc-mobile/src/services/field-sheet-result-layout.test.ts": ("Pruebas del intérprete móvil", "Verifica geometría real de dos filas con colspan/rowspan, fallback plano, row labels y widths declarativos seguros.", "node:test y helper de layout", "Suite MYC Mobile", "Alto"),
        "myc-mobile/src/components/field-sheets/FieldSheetResultsWorkspace.tsx": ("Workspace genérico de resultados", "Renderiza secciones y headers agrupados mediante posiciones calculadas, labels, anchos y scroll horizontal desde el snapshot sin ramas por template/organización.", "React Native, workspace-state y field-sheet-result-layout", "Captura técnica LAB", "Crítico"),
        ...
        "docs/architecture/FIELD_SHEET_PDF_RENDERER.md": ("Contrato PDF de Hojas de Campo", "Documenta renderer único/versionado, DSL, layouts seguros, perfiles, acabado visual global y compatibilidad histórica.", "Implementación backend/móvil y pruebas", "Arquitectura, desarrollo y QA", "Crítico"),
        "docs/architecture/FIELD_SHEET_TEMPLATE_INVENTORY_PHASE_6.md": ("Inventario de plantillas FieldSheet", "Distingue catálogos legacy/prototipo/oficial y registra la materialización versionada de Temperatura/Presión en Fase 6A.1.", "Motor, catálogos y contratos históricos", "Desarrollo, QA y auditoría", "Crítico"),
        ...
        "docs/closures/FIELD_SHEET_CATALOG_PHASE_6A1_2026-09-03.md": ("Evidencia Fase 6A.1 FieldSheets", "Registra fuentes, definiciones, compatibilidad, acabado visual global, PDFs y validaciones de Temperatura/Presión MYC con estado EN REVISIÓN.", "Código, PDFs fuente, arquitectura y suites", "Desarrollo, QA y auditoría", "Alto"),
    }
    ...
    lab_files = {
        ...
        "backend/app/services/lab_clients.py": ("Autoridad LabClient", "Gobierna identidad/deduplicación, CRUD, importación XLSX con aliases y campos estructurados, auditoría, scope y listado paginado estable.", "SQLAlchemy, openpyxl, LabClient, audit logs y schemas", "Router Mobile LAB y pruebas", "Crítico"),
        "backend/tests/test_lab_domain_phase1.py": ("Regresión de dominio LabClient", "Verifica identidad, campos opcionales, soft delete, propagación, permisos y listado server-side con búsqueda, limit, offset e inactivos.", "Pytest, TestClient, SQLAlchemy y servicios LAB", "Gate backend LabClient", "Alto"),
        ...
        "backend/app/routers/lab_work_orders.py": ("API móvil OT LAB", "Expone filtros/paginación, CRUD, adicionales, firma/cierre grupal o individual, PDF actual e historial/PDF por revisión bajo permisos explícitos. Añade q opcional por folio OR cliente, conservando filtros legacy y scope.", "FastAPI, schemas, servicios LAB/Tickets y auth Mobile", "myc-mobile y exportación administrativa", "Crítico"),
        "backend/app/schemas/lab_work_order.py": ("Contrato OT LAB", "Valida datos generales, equipos, firmas PNG y proyecta estado/sesión de cada hermana para distinguir cohortes.", "Pydantic y modelos LAB", "Router, servicio y cliente móvil", "Alto"),
        "backend/app/services/lab_work_orders.py": ("Dominio OT LAB", "Conserva el grupo histórico y orquesta miembros abiertos, cohortes versionadas grupales/individuales, inmutabilidad completed, PDFs, auditoría y exportación multisesión. Filtra q por subcadena literal de folio OR cliente case-insensitive, intersectado con filtros legacy y scope.", "SQLAlchemy, audit, PDF, Tickets e institutional_folio_sequences", "Router LAB, servicio Tickets, pruebas y retiro futuro", "Crítico"),
        ...
        "backend/tests/test_lab_work_orders.py": ("Suite OT LAB/Tickets", "Prueba grupo histórico, cierre, reapertura y además importación LabClient histórica/estructurada, aliases, auxiliares ignorados, ceros iniciales, inválidos y duplicados. Prueba q, filtros legacy, estado, paginación y permiso/scope del listado.", "Pytest, TestClient, openpyxl, pypdf, SQLite y PostgreSQL aislados", "Gate backend del vertical móvil", "Crítico"),
        "backend/tests/test_mobile_security_context.py": ("Regresión de seguridad Mobile", "Cubre identidad/scope staff-cliente y demuestra que Técnico internal crea grupo directo sin acceso al workflow administrativo externo, mientras cliente capaz solicita pero no materializa directo.", "FastAPI, SQLite, RBAC interno/externo y agregado LAB", "Gate backend de seguridad Mobile", "Crítico"),
        "backend/app/services/operational_tickets.py": ("Lifecycle de Tickets/reapertura", "Crea, lista y resuelve Tickets; reabre exclusivamente la cohorte identificada por sesión, con snapshots, auditoría, locks y eventos persistentes.", "SQLAlchemy, modelos Ticket/LAB, permisos, auditoría y Notifications", "Routers móviles, cierre LAB, revisores y pruebas PostgreSQL", "Crítico"),
        ...
        "myc-mobile/app/(technician)/work-orders.tsx": ("Flujo móvil OT LAB", "Presenta grupo histórico y estado por folio; elige cierre grupal o individual, conserva captura por contexto de cohorte y abre el PDF de cada OT sin alterar parentesco. Cabecera con buscador q debounced y dos accesos horizontales locales; conserva ajuste de teclado por plataforma.", "Expo Router, AuthProvider, Notifications, política de cohorte, firma y API LAB", "Técnicos autorizados en Expo Go/TestFlight", "Crítico"),
        ...
        "myc-mobile/src/components/lab/LabClientSelector.tsx": ("Selector remoto LabClient", "Evita requests con menos de dos caracteres, aplica debounce de 300 ms y consume como máximo cinco resultados remotos sin perder creación inline.", "React Native, servicio selector y API LabClient", "Formularios de OT y equipo LAB", "Alto"),
        ...
        "myc-mobile/src/services/lab-work-order-signature-submission.ts": ("Transporte de cierre LAB", "Selecciona rutas explícitas de firma/finalización grupal o individual y conserva payload doble, respuesta y error backend.", "SignaturePayload, LabClosureScope, LabWorkOrder y Request autenticado", "work-orders y pruebas de rutas", "Crítico"),
        "myc-mobile/src/services/lab-work-order-signature-submission.test.ts": ("Integración del handler de firma LAB", "Demuestra POST inicial, errores exactos y selección correcta de rutas grupales/individuales de firma y cierre.", "Node test, tsx y servicio de envío", "Gate móvil de firma LAB", "Alto"),
        "myc-mobile/src/services/lab-work-order-closure.ts": ("Política pura de cohorte LAB", "Deriva participantes abiertos, faltantes de equipo, disponibilidad grupal/individual y contexto estable de captura.", "LabWorkOrder", "Pantalla work-orders y pruebas Mobile", "Crítico"),
        "myc-mobile/src/services/lab-work-order-closure.test.ts": ("Regresión móvil de cohortes LAB", "Prueba grupo parcial, exclusión de completed, contextos distintos, acciones explícitas y navegación por estado.", "Node test, tsx y fuentes Mobile", "Gate móvil de cierre LAB", "Alto"),
        "myc-mobile/src/services/lab-client-selector.ts": ("Contrato de consulta LabClient", "Construye query selector limit=5 y administración limit=25/offset; decide mínimo de búsqueda y fusiona páginas sin duplicados.", "URLSearchParams y tipos LabClient", "Selector OT, módulo Clientes y pruebas", "Alto"),
        "myc-mobile/src/services/lab-client-selector.test.ts": ("Regresión de consulta LabClient", "Prueba mínimo de búsqueda, límites, include_inactive, offset, reemplazo/agregado de páginas, selección y creación inline.", "node:test, helper y fuente de clients.tsx", "Gate Mobile LabClient", "Alto"),
        ...
        "docs/architecture/LAB_WORK_ORDERS.md": ("Contrato OT LAB", "Documenta aislamiento, LabClient/importación, consulta paginada, grupo histórico, cohortes, folios, PDF, exportación y retiro.", "Código y pruebas LAB", "Desarrollo, operación, auditoría y retiro", "Alto"),
        "docs/closures/LAB_CLIENT_IMPORT_AND_QUERY_2026-09-02.md": ("Cierre técnico LabClient", "Registra causas, contratos XLSX/GET/Mobile, límites de persistencia, validaciones y QA físico pendiente.", "Implementación, arquitectura y pruebas LabClient", "Desarrollo, QA, operación y auditoría", "Alto"),
        ...
        "docs/closures/LAB_CLOSURE_COHORTS_2026-08-27.md": ("Cierre técnico de cohortes LAB", "Registra auditoría, solución, evidencia y límites de firma/finalización parcial sin disolver el grupo histórico.", "Contrato, implementación y validaciones LAB", "Dirección, QA y operación móvil", "Alto"),
    }
    ...
    phase_12_files = {
        ...
        "backend/app/resolution_integrations/installed.py": (
            "Composición institucional única",
            "Instala Certificados, equipo adicional y Herramientas administrativas ETS con presentación, schemas, fábricas e hidratadores compartidos, sin ramas por dominio en el Centro.",
            "Builders versionados de integraciones y metadata declarativa",
            "Centro, worker, API pública, Registry y pruebas",
            "Crítico",
        ),
        "backend/app/resolution_integrations/service_order_administration/__init__.py": (
            "API de integración administrativa ETS",
            "Expone definiciones versionadas y el builder único del vertical administrativo ETS.",
            "Application e infrastructure del vertical",
            "Composición institucional instalada",
            "Alto",
        ),
        "backend/app/resolution_integrations/service_order_administration/domain.py": (
            "Dominio determinista administrativo ETS",
            "Define solicitud, hechos, precheck, análisis, plan, simulación, autorización y revalidación serializables.",
            "Contratos puros del Motor",
            "Orchestrator, persistencia de snapshots y pruebas",
            "Crítico",
        ),
        "backend/app/resolution_integrations/service_order_administration/application.py": (
            "Definiciones administrativas ETS",
            "Registra restauración, reconstrucción y baja como identidades distintas sobre componentes versionados compartidos.",
            "Dominio del vertical y ResolutionDefinition",
            "Registry y Orchestrator",
            "Crítico",
        ),
        "backend/app/resolution_integrations/service_order_administration/infrastructure.py": (
            "Adaptadores administrativos ETS",
            "Lee hechos sin efectos, resuelve componentes y delega la ejecución transaccional al servicio propietario con referencias de entidad.",
            "SQLAlchemy, Motor y servicio propietario ETS",
            "Worker y Executor",
            "Crítico",
        ),
        "backend/app/services/service_order_administration.py": (
            "Servicio propietario administrativo ETS",
            "Ejecuta bajo lock restauración, reconstrucción idempotente y baja prístina preservando snapshots, OT, auditoría y Actividad.",
            "Quotation, ServiceOrder, dependencias downstream y servicios canónicos ETS",
            "Domain Gateway del Motor y pruebas",
            "Crítico",
        ),
        "backend/tests/resolution_engine/test_phase_15_service_order_administration.py": (
            "Suite específica de Fase 15",
            "Prueba manifiesto de herramientas, conservación del mismo ETS/OT, bloqueo de recreación ordinaria, reconstrucción idempotente y precheck de restauración.",
            "Centro, Motor, ETS, Cotizaciones y SQLite",
            "Gate técnico de Fase 15",
            "Crítico",
        ),
        "frontend/src/constants/navigation.js": (
        ...
        "frontend/src/pages/ResolutionCenterPage.jsx": (
            ...
            "Implementa vistas institucionales, formularios por metadata, expediente completo y la familia Herramientas administrativas sin reglas de dominio ni estado paralelo.",
        ...
        "frontend/src/pages/resolution-center.css": (
            "Estilos del Centro",
            "Integra vistas, tarjetas de herramientas, tabla, filtros, badges, modales y timeline responsive con variables visuales del ERP.",
    ...
    if value == "backend/tests/test_verification_metrological_pipeline.py":
        return ("Prueba de integración de Verificación", "Cubre inicial→final automático, A→A idempotente, A→B bloqueado sin evidencia, candidatos vigentes ignorados tras freeze, archivo de otro Master, revisión posterior, ambigüedad, ETS mixto, Calidad, autenticación y liberación.", "SQLAlchemy SQLite, ZIP/XLSX real y servicios metrológicos compartidos", "Pytest en CI y desarrollo", "Alto")
    if value == "frontend/src/pages/ServiceOrdersPage.jsx":
