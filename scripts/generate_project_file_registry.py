...
def classify(path: Path) -> tuple[str, str, str, str, str]:
    ...
    work_order_deletion_files = {
        ...
        "backend/app/services/lab_work_orders.py": ("Autoridad OT LAB", "Gestiona folios, grupo histórico, cohortes grupales/individuales, inmutabilidad completed, PDFs y eliminación atómica con reparación de cadena y recursos compartidos.", "Modelos LAB, Tickets, Notifications, Communications, auditoría y PDFs", "Router LAB, MYC Mobile y pruebas", "Crítico"),
