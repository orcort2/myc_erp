...
def classify(path: Path) -> tuple[str, str, str, str, str]:
    ...
    work_order_deletion_files = {
        ...
        "backend/tests/test_lab_work_orders.py": ("Suite integral OT LAB", "Cubre lifecycle, cohortes de cierre, congelamiento histórico, multisesión/export, Tickets y eliminación con rollback, reparentado y folios no reutilizables.", "Pytest, FastAPI, SQLAlchemy y agregado LAB", "Gate backend del vertical temporal", "Crítico"),
    ...
    lab_files = {
        ...
        "backend/tests/test_lab_work_orders.py": ("Suite OT LAB/Tickets", "Prueba grupo histórico, cierre grupal/individual, congelamiento completed, múltiples sesiones/export, reapertura por cohorte, lifecycle y concurrencia PostgreSQL opt-in.", "Pytest, TestClient, pypdf, SQLite y PostgreSQL aislados", "Gate backend del vertical móvil", "Crítico"),
        ...
        "docs/architecture/LAB_WORK_ORDERS.md": ("Contrato OT LAB", "Documenta aislamiento, grupo histórico, cohortes grupales/individuales, folios, API, PDF, exportación multisesión y retiro.", "Código y pruebas LAB", "Desarrollo, operación, auditoría y retiro", "Alto"),
