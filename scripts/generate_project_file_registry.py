...
def classify(path: Path) -> tuple[str, str, str, str, str]:
    ...
    maintenance_files = {
        ...
        "backend/app/security/api_access.py": ("Política transversal de acceso", "Clasifica 456 operaciones deny-by-default, incluidos los límites ETS y administrativos vigentes.", "FastAPI, permisos e inventario CSV", "Middleware, arranque, generador y pruebas", "Crítico"),
    ...
    work_order_deletion_files = {
        ...
        "backend/app/security/api_access.py": ("Política transversal de acceso", "Clasifica 456 operaciones deny-by-default y separa permisos internos, Portal y móvil.", "FastAPI, auth, catálogo de permisos e inventario CSV", "Middleware, arranque, generador y pruebas de conformidad", "Crítico"),
        ...
        "backend/tests/test_api_access_conformity.py": ("Prueba de conformidad API", "Exige clasificación de las 456 operaciones y coincidencia exacta entre runtime e inventario CSV.", "app.main, security.api_access e inventario CSV", "Suite backend y revisión de API", "Crítico"),
        ...
        "docs/architecture/security/API_ENDPOINT_INVENTORY_2026-08-03.csv": ("Evidencia reproducible API", "Registra 456 operaciones con método, ruta, identidad, permiso, ownership y pruebas esperadas.", "generate_api_access_inventory.py y app runtime", "Conformidad, revisión externa y CI futura", "Crítico"),
    }
