...
def classify(path: Path) -> tuple[str, str, str, str, str]:
    ...
    field_sheet_dsl_files = {
        ...
        "backend/app/services/field_sheet_template_engine.py": ("Autoridad declarativa de plantillas", "Define familias, bloques, pilotos y defaults tipados de firmas sin persistencia ni cálculos metrológicos.", "Schemas de plantilla y FastAPI", "Normalizador, catálogo y servicios FieldSheet", "Crítico"),
        ...
        "backend/tests/test_field_sheet_layout_dsl.py": ("Aceptación DSL/PDF Hojas de Campo", "Prueba layouts, perfiles, firmas horizontal/vertical, trailing fields allowlisted, rechazos 422, seguridad y PDF real.", "Pytest, normalizador, Jinja y WeasyPrint", "Gate Fases 4+5", "Crítico"),
