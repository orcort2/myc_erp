...
TICKET_TYPES = ("reopen_work_order",)
TICKET_STATUSES = (
    "pending",
    "approved",
    "rejected",
...
class OperationalTicket(IntegerPkMixin, TimestampMixin, Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "type IN ('reopen_work_order')", name="ck_operational_ticket_type"
        ),
        CheckConstraint(
    ...
    requested_signature_policy: Mapped[str] = mapped_column(String(20), nullable=False)
