...
export default function WorkOrdersScreen() {
  ...
  return (
    <SafeAreaView style={styles.screen}>
      ...
      <Pressable style={styles.primary} onPress={startNew}><Text style={styles.primaryText}>+ Generar orden</Text></Pressable>
            ...
            <ScrollView contentContainerStyle={styles.modalContent} keyboardShouldPersistTaps="handled">
              {step === 'general' && (
                <>
                  ...
                  <Field label="Teléfono" keyboardType="phone-pad" value={general.contact_phone} onChangeText={(value) => setGeneral({ ...general, contact_phone: value })} />
                  <Field label="Correo" keyboardType="email-address" value={general.contact_email} onChangeText={(value) => setGeneral({ ...general, contact_email: value })} />
...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 20, paddingTop: 12 }, back: { color: '#0067a8', fontSize: 17, marginBottom: 12 }, title: { fontSize: 29, fontWeight: '800' }, subtitle: { color: '#667582', marginTop: 4 },
  primary: { alignItems: 'center', backgroundColor: '#0067a8', borderRadius: 10, justifyContent: 'center', margin: 20, minHeight: 52, paddingHorizontal: 16 }, primaryText: { color: '#fff', fontSize: 16, fontWeight: '700' },
  ...
  modalScreen: { backgroundColor: '#f7f9fb', flex: 1 }, modalHeader: { alignItems: 'center', backgroundColor: '#fff', borderBottomColor: '#dce3e9', borderBottomWidth: 1, flexDirection: 'row', justifyContent: 'space-between', padding: 16 }, modalTitle: { fontSize: 20, fontWeight: '800' }, modalHint: { color: '#637280', fontSize: 12, marginTop: 2 }, close: { color: '#0067a8', fontSize: 16, fontWeight: '700' }, modalContent: { padding: 20, paddingBottom: 70 }, sectionTitle: { fontSize: 23, fontWeight: '800', marginBottom: 18 }, sectionRow: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, counter: { color: '#0067a8', fontSize: 18, fontWeight: '800' },
  field: { marginBottom: 14 }, fieldLabel: { color: '#344553', fontSize: 14, fontWeight: '700', marginBottom: 6 }, input: { backgroundColor: '#fff', borderColor: '#b9c5cf', borderRadius: 9, borderWidth: 1, fontSize: 16, minHeight: 48, paddingHorizontal: 12 }, multiline: { minHeight: 78, paddingTop: 12, textAlignVertical: 'top' },
  ...
  overlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(16,28,38,0.55)', justifyContent: 'flex-end', zIndex: 20 }, overlayCard: { backgroundColor: '#f8fafb', borderTopLeftRadius: 20, borderTopRightRadius: 20, maxHeight: '92%', padding: 20 }, conditionRow: { flexDirection: 'row', gap: 10, marginBottom: 18 }, condition: { alignItems: 'center', backgroundColor: '#e7ecef', borderRadius: 9, flex: 1, padding: 14 }, conditionSelected: { backgroundColor: '#bde8c9' }, conditionBadSelected: { backgroundColor: '#f5c6cc' }, conditionText: { fontSize: 16, fontWeight: '800' }, actionRow: { flexDirection: 'row', gap: 10 }, cancel: { alignItems: 'center', backgroundColor: '#e3e8ec', borderRadius: 9, flex: 1, justifyContent: 'center', minHeight: 50 }, save: { alignItems: 'center', backgroundColor: '#0067a8', borderRadius: 9, flex: 2, justifyContent: 'center', minHeight: 50 }, delete: { color: '#a51c30', fontSize: 16, fontWeight: '700', padding: 18, textAlign: 'center' },
  busy: { alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.68)', borderRadius: 10, flexDirection: 'row', gap: 10, left: 90, padding: 12, position: 'absolute', right: 90, top: 82, zIndex: 50 }, busyText: { color: '#fff', fontWeight: '700' },
});
