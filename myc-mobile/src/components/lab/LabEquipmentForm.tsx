...
export function LabEquipmentForm({
  ...
  function updateEquipment<K extends keyof EquipmentBasicData>(
    field: K,
    value: EquipmentBasicData[K],
  ) {
  ...
  return (
    <View style={styles.panel}>
      ...
      <Field
        ...
        onChange={(value) => updateEquipment('brand', value)}
      />
      ...
      <Field
        ...
        onChange={(value) => updateEquipment('model', value || null)}
      />
      ...
      <Field
        ...
        onChange={(value) => updateEquipment('identification', value)}
      />
      ...
      {service === 'linked' ? (
        <Field
          ...
          onChange={(value) =>
            updateEquipment('report_number', value || null)
          }
        />
      ) : (
      ...
      <View style={styles.row}>
        <Pressable
          ...
          style={[
            styles.choice,
            equipment.is_good_condition && styles.choiceActive,
          ]}
        >
          <Text>✓ Bueno</Text>
        </Pressable>
        ...
        <Pressable
          ...
          style={[
            styles.choice,
            !equipment.is_good_condition && styles.choiceBad,
          ]}
        >
          <Text>X Malo</Text>
        </Pressable>
