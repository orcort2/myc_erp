...
const equipment = {
  instrument: 'Manómetro', brand: 'MYC', identification: 'ID-1', serial_number: 'SER-1',
...
function savedEquipment(overrides: Partial<LabEquipment> = {}): LabEquipment {
  return {
    id: 1, position: 1, instrument: 'Manómetro', brand: 'MYC', identification: 'ID-1', serial_number: 'SER-1',
