...
| --- | --- | --- | --- | --- |
| TD-008 | P1 | La autoridad documental PDF ya soporta DSL estructural, headers multinivel, layout seguro y perfiles MYC/CAPYMET en un renderer versionado; Fase 6A.1 materializó y verificó visualmente Temperatura/Presión MYC, pero todavía faltan el asset institucional definitivo CAPYMET, el resto del catálogo oficial de hojas/magnitudes y la validación visual/física de cada formato pendiente. | `FieldSheetLayout.jsx`, `fieldSheetPagination.js`, `field_sheet_engine_pdf.html`, perfiles y servicios PDF | Fase 6A.2 y siguientes: incorporar únicamente definiciones oficiales validadas y el asset CAPYMET aprobado; ejecutar QA visual por formato sin crear renderers específicos ni romper históricos. |
