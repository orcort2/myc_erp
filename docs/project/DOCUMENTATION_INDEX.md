...
| [`../architecture/MOBILE_SECURITY_CONTEXT.md`](../architecture/MOBILE_SECURITY_CONTEXT.md) | Identidad Mobile internal/client, BIOMETRIC-1: dispositivos independientes, sesiones persistentes, refresh opaco rotatorio, reuse, logout, single-flight y transición legacy temporal; RBAC, scope, realtime y push. |
