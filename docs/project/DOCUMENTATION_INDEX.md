...
| [`../architecture/security/API_ENDPOINT_INVENTORY_2026-08-03.csv`](../architecture/security/API_ENDPOINT_INVENTORY_2026-08-03.csv) | Inventario reproducible vigente de 463 operaciones FastAPI; conserva la fecha del archivo de origen y su política mínima verificable. |
