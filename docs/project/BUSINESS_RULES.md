...
| BR-035 | Motor de Resoluciones | Consultar auditoría exige una decisión `resolution.audit.inspect` concedida y ligada a resolución, actor, correlación, recurso y organización exactos. El expediente completo se verifica antes de filtrar; evidencia ajena, hash incompatible, referencia ausente o hueco de secuencia produce diagnóstico estable. Una consulta nunca modifica Lifecycle ni invoca ejecución, compensación o outbox. | [`../architecture/resolution-engine/20_AUDIT_EVIDENCE.md`](../architecture/resolution-engine/20_AUDIT_EVIDENCE.md) y pruebas de Fase 7 | 2026-07-27 |
