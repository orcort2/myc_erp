...
>
> Autoridad: Alta para claves y semántica canónica de campos; no determina el avance de implementación
>
> Prevalece sobre: nombres de campo incompatibles en implementaciones y especificaciones históricas
>
> Relación: MDE es un consumidor futuro opcional, no el documento padre vigente
...
Documento relacionado de diseño futuro: `future/MDE_SPEC.md`
