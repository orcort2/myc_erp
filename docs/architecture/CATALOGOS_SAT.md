...
>
> Autoridad: Alta para fuentes, importación y consumo de Catálogos SAT
>
> Prevalece sobre: el reporte de carga inicial y propuestas antiguas de catálogos fiscales en JSON
