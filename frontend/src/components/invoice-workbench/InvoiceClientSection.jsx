  ...
  return (
    <section className="invoice-draft-section">
      ...
      <div className="invoice-sat-grid invoice-sat-grid--client">
        <SatCatalogField catalog={catalogByCode.get('fiscal_regimes')} catalogCode="fiscal_regimes" label="Régimen fiscal" onChange={(value) => onChange('fiscalRegime', value)} showAllOnOpen value={draft.fiscalRegime} />
